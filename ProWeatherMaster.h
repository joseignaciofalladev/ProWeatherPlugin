...
public:
	...
	/** Fog */
	UPROPERTY(EditAnywhere, Category = "Weather | Fog")
	...
	/** Skylight */
	UPROPERTY(EditAnywhere, Category = "Weather | SkyLight")
	float SkyLightIntensityOfDay = 1.2f;

	UPROPERTY(EditAnywhere, Category = "Weather | SkyLight")
	float SkyLightIntensityOfNight = 1.0f;
...
public:
	...
	/** Sound cues (Asignados en el .cpp o editor) */
	USoundCue* RainSound;
	...
	/** Timeline callbacks */
	UFUNCTION()
	void UpdateIsNightTimeLine(float Output);

	UFUNCTION()
	void UpdateSunTimeLine(float Output);

	UFUNCTION()
	void UpdateSnowOrRainFallingTimeLine(float Output);

	UFUNCTION()
	void UpdateRainFallingTimeLine(float Output);

	UFUNCTION()
	void UpdateSnowFallingTimeLine(float Output);

	UFUNCTION()
	void UpdateGetWetTimeLine(float Output);

	UFUNCTION()
	void UpdateFrozenTimeLine(float Output);
};
